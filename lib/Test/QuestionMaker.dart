                                      ...
                                      return Container(
                                        ...
                                        child: RaisedButton(
                                          ...
                                          onPressed: () {
                                            attempted++;
                                            if (c==0){
                                              array.add(MyVector(ques: snapshot.data["values"][index][1],selected_option: option,ans: snapshot.data["values"][index][6]));
                                            }
                                            if ((index <20) &&
                                                (Check(
                                                    option,
                              ...
                              index == 20
                                  ...
                                  onPressed: () {
                                    ...
                                    setState(() {
                                      ...
                                      Navigator.push(context,MaterialPageRoute(builder: (context)=>Score_review_single_sub(sub: array,score: score,attempted: attempted,negative: negative,not_attempted: not_attempted,)));
