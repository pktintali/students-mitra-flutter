...
class _TestState extends State<Test> {
  ...
  void initState() {
    super.initState();
    String user="https://sheets.googleapis.com/v4/spreadsheets/1nKZxQH1nAVPPhpSLH1tPlYcW31-ZRM9qi7KoGvpLroc/values/${widget.sub}?key=AIzaSyBHa8gIZFiDDGmSUKiDPBn6I-aDt6e0IHc";
    _get();
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasData) {
            ...
            return ListView.builder(
                itemCount: snapshot.data["values"].length-(snapshot.data["values"].length-10),
                itemBuilder: (BuildContext context, int index){
                  ...
                  return index>=1 && index<10?Center(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                Container(
                                  ...
                                  child: Flexible(child: Text(snapshot.data["values"][index][1],style: TextStyle(fontSize: 25.0),)),
                                ),
